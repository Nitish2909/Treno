...
const MOCK_BLOGS = [
  {
    ...
    excerpt:
      "Everything you need to know before embarking on your first Himalayan trek — from essential gear to altitude acclimatization tips.",
    category: "Trekking",
  ...
  },
  {
    ...
    excerpt:
      "Beyond the crowded tourist spots lie secret shores where the sand is pristine and the vibe is blissfully serene.",
  ...
  },
  {
    ...
    excerpt:
      "Dive into the vibrant flavours of Rajasthan — from dal baati churma in Jaipur to the iconic ghewar of Udaipur.",
    category: "Food",
  ...
  },
  {
    ...
    excerpt:
      "Monsoon transforms India into a lush paradise. Here is how to travel safely and make the most of the season.",
    category: "Tips",
  ...
  },
  {
    ...
    excerpt:
      "Yes, you can experience the magic of Ladakh without breaking the bank. We break down every expense so you can plan better.",
    category: "Tips",
    author: { name: "Sneha Joshi" },
    coverImage:
      "https://images.pexels.com/photos/2437290/pexels-photo-2437290.jpeg",
  ...
  },
  {
    ...
    excerpt:
      "Discover the incredible diversity of Northeast India — its tribes, languages, cuisine, and breathtaking festivals.",
    category: "Culture",
  ...
  },
  {
    ...
    excerpt:
      "Escape the crowds and explore misty peaks, cascading waterfalls, and endemic wildlife along the Western Ghats.",
    category: "Adventure",
    author: { name: "Priya Sharma" },
  ...
  },
  {
    ...
    excerpt:
      "Journey through coastal Kerala to unearth century-old recipes, aromatic spice trade stories, and rich coastal flavors.",
    category: "Food",
  ...
  },
  {
    ...
    excerpt:
      "From Pangong Tso to Chandratal, discover the turquoise high-altitude waters cradled in the Trans-Himalayan desert.",
    category: "Travel",
    author: { name: "Amit Das" },
    coverImage:
  ...
  },
  {
    ...
    excerpt:
      "Uncover Dravidian architectural marvels, intricate gopurams, and millennia-old traditions preserved in South India.",
    category: "History",
...
export default function Blog() {
  ...
  const totalPages =
    blogsData?.totalPages ?? Math.ceil(filteredBlogs.length / PAGE_SIZE);
  ...
  return (
    <>
      <SEOHead
        title="Travel Blog | Travel Tips, Destination Guides & Tour Advice | Trip With Treno"
        description="Explore the latest travel blogs from Trip With Treno. Discover destination guides, travel tips, trekking adventures, budget travel ideas, family vacations, honeymoon destinations, weekend getaways, international travel guides, and expert advice for planning your next trip."
        keywords={[
          "Trip With Treno Blog",
          "Travel Blog",
          "Travel Tips",
          "Travel Guides",
          "Destination Guides",
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={cat.name}>
                  ...
                  >
                    <span className="text-sm text-slate-700 group-hover:text-amber-700">
                      {cat.name}
                    </span>
