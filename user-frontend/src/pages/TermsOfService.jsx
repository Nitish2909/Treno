...
const SECTIONS = [
    ...
    content: [
      {
        ...
        body: "A booking is confirmed only upon receipt of payment (full or partial deposit as specified) and issuance of a confirmation email from Treno. Availability is subject to change until payment is received.",
      },
      {
        heading: "Pricing",
        body: "All prices are listed in Indian Rupees (INR) unless otherwise stated. Prices are subject to change without notice until a booking is confirmed. Treno reserves the right to correct pricing errors.",
      },
      {
      ...
      },
      {
        ...
        body: "Each trip's listing clearly states what is included and excluded. Treno is not responsible for expenses not listed as inclusions (e.g., personal expenses, tips, visa fees).",
      },
    ],
  },
  {
    ...
    content: [
      ...
      "Processing fees and payment gateway charges (typically 2–3%) are non-refundable in all cases.",
      {
        ...
        body: "Cancellations must be submitted in writing via your Treno account dashboard or by emailing trenotravel@gmail.com. The cancellation date is the date we receive your written request.",
      },
      {
        heading: "Treno-Initiated Cancellations",
        body: "If Treno cancels a trip due to insufficient bookings, natural disasters, government advisories, or other circumstances beyond our control, you will receive a full refund or the option to transfer to an alternative trip.",
      },
      {
        heading: "Travel Insurance",
        body: "We strongly recommend purchasing comprehensive travel insurance that covers trip cancellation, medical emergencies, and baggage loss. Treno can recommend insurance partners upon request.",
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        body: "It is your sole responsibility to ensure that you hold all required and valid travel documents for your trip, including but not limited to passports, visas, inner line permits, national park permits, and health certificates.",
      },
      {
        heading: "Passport & Visa",
        body: "For international trips, your passport must be valid for at least 6 months beyond your return date. Visa requirements vary by nationality and destination. Treno can advise on general requirements but is not responsible for visa denials or incorrect documentation.",
      },
      {
        heading: "Domestic ID",
        body: "For domestic India trips, a government-issued photo ID (Aadhaar Card, PAN Card, Voter ID, or Passport) is mandatory for all travellers and must be produced at the time of check-in.",
      },
      {
      ...
      },
      {
        ...
        body: "We recommend carrying both physical and digital copies of all important documents. Treno bears no responsibility for losses arising from missing or invalid documentation.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        body: "You agree to follow all safety instructions given by Treno guides and staff. Failure to comply may result in removal from the trip without refund.",
      },
      {
      ...
      //   body: "Treno maintains emergency protocols and first-aid trained guides for all trips. In case of a medical emergency, our team will arrange evacuation to the nearest medical facility. Costs of emergency evacuation are the traveller's responsibility.",
      // },
      {
  ...
  },
  {
    ...
    content: [
      {
        heading: "Scope",
        body: "To the maximum extent permitted by applicable law, Treno, its directors, employees, agents, and partners shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our services.",
      },
      {
        heading: "Third Parties",
        body: "Treno acts as an organiser and coordinator of travel experiences. We work with independent third-party suppliers (hotels, airlines, activity operators). While we vet our partners, Treno is not responsible for the acts, omissions, or defaults of these third parties.",
      },
      {
        heading: "Force Majeure",
        body: "Treno shall not be liable for any failure or delay in performance arising from circumstances beyond our reasonable control, including natural disasters, acts of God, war, terrorism, government actions, pandemics, or strikes.",
      },
      {
        heading: "Cap on Liability",
        body: "Where liability cannot be excluded by law, Treno's total liability to you for any claim shall not exceed the amount you paid to Treno for the specific trip giving rise to the claim.",
      },
      {
        heading: "Indemnification",
        body: "You agree to indemnify and hold Treno harmless from any claims, damages, or expenses (including legal fees) arising from your violation of these Terms, your negligence, or your wilful misconduct during a trip.",
      },
    ],
  },
  {
    ...
    content: [
      "Treno reserves the right to modify these Terms of Service at any time. We will provide reasonable notice of significant changes by sending an email to your registered email address and posting a notice on our website with the effective date of changes.",
      {
        ...
        body: "Your continued use of Treno's services after the effective date of any modifications constitutes your acceptance of the revised Terms.",
      },
      {
      ...
      },
      {
        ...
        body: "These Terms, together with our Privacy Policy and any booking-specific terms, constitute the entire agreement between you and Treno regarding your use of our services.",
      },
      {
        heading: "Contact Us",
        body: "For any questions about these Terms, please contact us at Trenotravel@gmail.com or write to us at SCO 98, Sec 4-5, Urban Estate, Karnal, Haryana — 132001.",
      },
    ],
  },
];
...
const REFUND_TABLE = [
  ...
  { period: "10-12 days before departure", refund: "50% Refund", icon: "amber" },
      ...
      <section className="bg-gradient-to-br from-slate-800 to-slate-900 py-16 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-slate-300 mt-4 max-w-xl mx-auto leading-relaxed">
            Please read these terms carefully before booking with Treno. By
