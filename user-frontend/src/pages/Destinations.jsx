    ...
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <header className="">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => setSelectedDestination(null)}>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {selectedDestination ? (
          ...
          <div>
            <div className="mb-8">
              <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Explore Top Destinations</h1>
              <p className="text-gray-500 mt-1">Pick a destination to explore detailed itineraries and highlights.</p>
            </div>
