...
// const InternationalTripDetails = () => {
...
//   return (
//     <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 font-sans text-slate-800 antialiased">
//       {/* Header Section */}
//       <div className="mb-8">
//         <div className="flex flex-wrap items-center gap-2.5 mb-3">
//           {destination.state && (
//             <span className="bg-blue-600/10 text-blue-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider border border-blue-200/50">
//               {destination.state}
//             </span>
//           )}
//           {destination.pricing?.discountPercentage && (
...
//         <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-2 capitalize">
//           {destination.name || slug}
//         </h1>

//         {destination.tagline && (
//           <p className="text-lg md:text-xl font-medium text-slate-500 italic">
//             "{destination.tagline}"
//           </p>
//         )}
//       </div>
...
//         <div className="rounded-2xl overflow-hidden shadow-sm border border-slate-100 bg-slate-100 h-80 md:h-96 relative">
//           <img
//             src={destination.image || "https://via.placeholder.com/800x400"}
//             alt={destination.name || "Destination"}
//             className="w-full h-full object-cover"
//           />
//           {destination.urgencyText && (
//             <div className="absolute bottom-4 left-4 bg-red-600/90 backdrop-blur-md text-white text-xs font-bold px-3 py-1.5 rounded-lg shadow-md">
//               🔥 {destination.urgencyText}
//             </div>
//           )}
//         </div>
...
//           {/* Grid Layout: 1 card wide on mobile, 2 on medium screens, 3 on desktop */}
...
const InternationalTripDetails = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-0 font-sans text-slate-800 antialiased">
      ...
      <div className="w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] relative w-full h-[420px] md:h-[400px]  overflow-hidden shadow-2xl  mb-10 ">
        {/* Background Image */}
        <img
        ...
        <div className="relative z-10 flex flex-col justify-end h-full p-6 md:p-12 pb-8 max-w-3xl text-white">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-2 leading-tight">
            <span style={{ textTransform: "capitalize" }}>
              {`${destination.name || slug} Tour Packages 2026`}
            </span>
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            className="flex items-center gap-2 bg-amber-400 hover:bg-amber-300 text-slate-950 font-bold px-6 py-3 rounded-full transition-colors shadow-lg text-sm md:text-base">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
