...
import {
  ...
  CheckCircle, ChevronDown, ChevronUp, Instagram, Facebook, Youtube
} from 'lucide-react'
    ...
    <div className="space-y-3">
      {faqs.map((faq, idx) => (
        <div key={idx} className="border border-slate-200 rounded-xl overflow-hidden bg-white">
          ...
          >
            <span className="font-semibold text-slate-700 text-sm pr-4">{faq.q}</span>
            {openIdx === idx ? (
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={['contact Treno', 'travel inquiry', 'trip support', 'book trip india']}
      />
      ...
      <section className="bg-gradient-to-br from-amber-50 to-orange-50 py-16 px-4 text-center border-b border-amber-100">
        ...
        >
          <p className="text-amber-500 font-semibold uppercase tracking-widest text-sm mb-3">We're here to help</p>
          <h1 className="font-playfair text-4xl md:text-5xl font-bold text-slate-800">Get in Touch</h1>
          <p className="text-slate-500 mt-4 max-w-lg mx-auto text-lg">
            Have a question about a trip? Want to customise your itinerary? We'd love to hear from you.
          </p>
        </motion.div>
      </section>
      ...
      <section className="max-w-screen-xl mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <div>
              <h2 className="font-playfair text-2xl font-bold text-slate-800 mb-6">Contact Information</h2>
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
                  ...
                  <div>
                    ...
                    <a href="tel:+919876543210" className="text-slate-800 font-semibold hover:text-amber-600 transition-colors">
                      +91-9876543210
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@Treno.in" className="text-slate-800 font-semibold hover:text-amber-600 transition-colors">
                      hello@Treno.in
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-slate-800 font-semibold leading-snug">
                      123 Travel Hub, Connaught Place<br />
                      New Delhi — 110001
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-0.5">Working Hours</p>
                    <p className="text-slate-800 font-semibold">Mon–Sat: 9 AM – 7 PM</p>
            ...
            {/* Social */}
            <div>
              <p className="text-sm font-semibold text-slate-600 mb-3">Follow Us</p>
              <div className="flex gap-3">
                {[
                  { Icon: Instagram, label: 'Instagram', href: '#', color: 'hover:bg-pink-50 hover:border-pink-200 hover:text-pink-500' },
                  { Icon: Facebook, label: 'Facebook', href: '#', color: 'hover:bg-blue-50 hover:border-blue-200 hover:text-blue-600' },
                  { Icon: Youtube, label: 'YouTube', href: '#', color: 'hover:bg-red-50 hover:border-red-200 hover:text-red-500' },
                  { Icon: MessageCircle, label: 'WhatsApp', href: 'https://wa.me/919876543210', color: 'hover:bg-green-50 hover:border-green-200 hover:text-green-600' },
          ...
          >
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 md:p-8">
              <h2 className="font-playfair text-2xl font-bold text-slate-800 mb-6">Send Us a Message</h2>
      ...
      <section className="max-w-screen-xl mx-auto px-4 pb-12">
        <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm" style={{ height: 320 }}>
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl p-6 text-center z-10 border border-slate-100">
              <MapPin className="w-10 h-10 text-amber-500 mx-auto mb-2" />
              <p className="font-bold text-slate-700">Treno HQ</p>
              <p className="text-slate-500 text-sm mt-1">123 Travel Hub, Connaught Place, New Delhi</p>
              <a
            ...
            <p className="absolute bottom-4 text-xs text-slate-400">Interactive map coming soon</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-screen-xl mx-auto px-4 pb-20">
        <div className="bg-amber-50 rounded-2xl border border-amber-100 p-6 md:p-8">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h2 className="font-bold text-slate-800 text-lg">Have a question?</h2>
              <p className="text-slate-500 text-sm">Browse our quick FAQs below</p>
            </div>
          </div>
