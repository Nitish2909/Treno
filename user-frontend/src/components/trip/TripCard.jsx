...
//   // Destructure using your nested validator schema layout
//   const {
//     _id,
//     title,
//     slug,
...
//   const { original: originalPrice, discounted: discountedPrice, currency } = price;
//   const { from, destinations = [] } = location;
//   const { min: minGroupSize, max: maxGroupSize } = groupSize;

//   // Handle image mapping cleanly
//   const primaryImage = images?.[0] ?? { url: trip.thumbnail?.url || '', alt: title };
...
//             <span>{minGroupSize || 1}–{maxGroupSize} people</span>
//           </div>
//         )}
