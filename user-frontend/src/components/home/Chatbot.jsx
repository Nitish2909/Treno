    ...
    <div className="fixed bottom-6 right-6 z-50 font-sans">
      ...
      {!isOpen && (
        <button
          ...
          className="flex flex-col items-center justify-center w-14 h-14 bg-[#1e5629] rounded-full shadow-2xl overflow-hidden hover:scale-105 transition-transform duration-200 border-2 border-[#2d7d3d] focus:outline-none "
        >
          <img
            src={AVATAR_URL}
            alt="Ira"
